...
const RoleSignUp = () => {
    ...
    const handleSignUp = (e) => {
        ...
        // Persistence logic for mock authentication
        const registeredUsers = JSON.parse(localStorage.getItem('registered_users') || '[]');
        const userExists = registeredUsers.some(u => u.email === trimmedUsername && u.role === normalizedRole);
    ...
    return (
        <div className="login-page-container">
            <div className="login-glass-card narrow">
                ...
                <p className="login-subtitle">Create your account to access the portal.</p>
                ...
                {success ? (
                    ...
                    <form className="login-form" onSubmit={handleSignUp}>
                        ...
                        <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
                            <span style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>Already have an account? </span>
                            <a 
                                href="#" 
                                onClick={(e) => { e.preventDefault(); navigate(`/login/${normalizedRole.toLowerCase()}`); }}
